...
import { Sparkles, ArrowRight, Leaf, Flower2 } from 'lucide-react';
...
export const PopularPlantsSection: React.FC<PopularPlantsSectionProps> = ({
  ...
  return (
    <section className="py-16 sm:py-20 bg-background-cream border-b border-surface-default overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <p className="font-body text-slate-700 text-sm sm:text-base leading-relaxed">
            Explore our most loved indoor and outdoor plants, carefully selected by our customers for homes, offices, balconies, and gardens.
          </p>
        </div>
